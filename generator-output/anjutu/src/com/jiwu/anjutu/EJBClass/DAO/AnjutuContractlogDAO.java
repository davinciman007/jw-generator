...
/**
 * description anjutucontractlog EJB DAO
 * 2014-8-19 10:18:10
 * @author jiwurapid
 */
@SuppressWarnings("unchecked")
@Stateless(name = "anjutucontractlogDAO")
@Local(IGenericDAO.class)

public class AnjutuContractlogDAO extends  GenericDAOImpl<AnjutuContractlog, Integer> {
