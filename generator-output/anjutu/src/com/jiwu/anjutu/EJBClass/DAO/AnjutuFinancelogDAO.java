...
/**
 * description anjutufinancelog EJB DAO
 * 2014-8-19 10:19:02
 * @author jiwurapid
 */
@SuppressWarnings("unchecked")
@Stateless(name = "anjutufinancelogDAO")
@Local(IGenericDAO.class)

public class AnjutuFinancelogDAO extends  GenericDAOImpl<AnjutuFinancelog, Integer> {
