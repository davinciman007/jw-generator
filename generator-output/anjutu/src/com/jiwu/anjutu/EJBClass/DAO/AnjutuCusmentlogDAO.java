...
/**
 * description anjutucusmentlog EJB DAO
 * 2014-8-19 10:18:31
 * @author jiwurapid
 */
@SuppressWarnings("unchecked")
@Stateless(name = "anjutucusmentlogDAO")
@Local(IGenericDAO.class)

public class AnjutuCusmentlogDAO extends  GenericDAOImpl<AnjutuCusmentlog, Integer> {
