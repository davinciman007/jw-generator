...
/**
 * description anjutuflatconfig EJB DAO
 * 2014-8-19 10:19:08
 * @author jiwurapid
 */
@SuppressWarnings("unchecked")
@Stateless(name = "anjutuflatconfigDAO")
@Local(IGenericDAO.class)

public class AnjutuFlatconfigDAO extends  GenericDAOImpl<AnjutuFlatconfig, Integer> {
